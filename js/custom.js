                    ...
                    data.portfolio.forEach((item, index) => {
                        ...
                        col.innerHTML = `
                            <div class="portfolio_card h-100 position-relative overflow-hidden">
                                ...
                                <!-- CHECKBOX -->
                                <input type="checkbox" name="selected_portfolios[]" value="0" class="portfolio_check" data-port-id="${index}" style="position:absolute; top:0; left:0; width:100%; height:100%; z-index:5;opacity:0;">
